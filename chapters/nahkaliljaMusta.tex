...
\captionof{figure}{1: Valmistele työtaso kuten tässä kuvattu}
\end{center}\end{Figure}
\begin{Figure}\begin{center}
\noindent\includegraphics[width=0.9\linewidth]{assets/valipala2}
\captionof{figure}{2: Laita leipäviipaleet pöytään}
\end{center}\end{Figure}
\end{multicols}
...
\captionof{figure}{5: Laita valmis valipala pussiin}
\end{center}\end{Figure}
\begin{Figure}\begin{center}
\noindent\includegraphics[width=0.9\linewidth]{assets/valipala2}
